          ...
          <div className="large-div" style={{marginTop: 20, marginBottom: 30}}>프로젝트</div>
            <div className="project">
              ...
              <div><div className="large-div">[hyper-tictactoe] 독특한 룰을 여러개 적용한 1인개발 온라인 매칭 틱택토게임&nbsp;
                <button><a href="https://github.com/nowaveosu/hyper-tictactoe" target="_blank" rel="noreferrer">Github</a></button>
                <button><a href="https://www.hyper-tictactoe.com/" target="_blank" rel="noreferrer">Web</a></button></div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[펫칭] 펫시터와 반려동물 주인 매칭 웹 서비스&nbsp;
                <button><a href="https://github.com/Petching/Petching" target="_blank" rel="noreferrer">Github</a></button>
                <button><a href="https://petching.net/" target="_blank" rel="noreferrer">Web</a></button></div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[도와조약] 사용자 알러지 기반 알약 추천 웹 서비스&nbsp;
                <button><a href="https://github.com/codestates-seb/seb43_main_009" target="_blank" rel="noreferrer">Github</a></button>
                <button><a href="https://dowajoyak.store" target="_blank" rel="noreferrer">Web</a></button></div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[해커톤: 같이탈래] 같은 경로를 이용하는 택시 이용자를 매칭하는 어플리케이션&nbsp;
                <button><a href="https://github.com/nowaveosu/gachiTarlae" target="_blank" rel="noreferrer">Github</a></button>
                </div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[토이 프로젝트] 손에 맞는 마우스 추천 사이트&nbsp;
                <button><a href="https://github.com/nowaveosu/lifemouse" target="_blank" rel="noreferrer">Github</a></button>
                <button><a href="https://nowaveosu.github.io/lifemouse/welcome.html" target="_blank" rel="noreferrer">Link</a></button>
                </div></div>
