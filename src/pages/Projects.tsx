          ...
          <div className="large-div" style={{marginTop: 20, marginBottom: 30}}>프로젝트</div>
            <div className="project">
              ...
              <div><div className="large-div">[hyper-tictactoe] 독특한 룰을 여러개 적용한 1인개발 온라인 매칭 틱택토게임&nbsp;
                ...
                <button><a style={{color: "rgb(126, 206, 249)"}} href="https://www.hyper-tictactoe.com/" target="_blank" rel="noreferrer">Web</a></button></div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[펫칭] 펫시터와 반려동물 주인 매칭 웹 서비스&nbsp;
                ...
                <button><a style={{color: "rgb(126, 206, 249)"}} href="https://petching.net/" target="_blank" rel="noreferrer">Web</a></button></div></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[도와조약] 사용자 알러지 기반 알약 추천 웹 서비스&nbsp;
                ...
                <button><a style={{color: "rgb(126, 206, 249)"}} href="https://dowajoyak.store" target="_blank" rel="noreferrer">Web</a></button></div></div>
