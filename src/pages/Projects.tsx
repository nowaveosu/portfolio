        ...
        <div className="content-box-small">
          ...
          <div className="project">
              ...
              <div><div className="large-div">[가려움없는세상] 아토피 환자 정보공유 게시판&nbsp;
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://github.com/nowaveosu/muri-shop" target="_blank" rel="noreferrer">Github</a></button>
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://nomoreitch.vercel.app/" target="_blank" rel="noreferrer">Link</a></button></div><hr /><br /></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[hyper-tictactoe] 독특한 룰을 여러개 적용한 1인개발 온라인 매칭 틱택토게임&nbsp;
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://github.com/nowaveosu/hyper-tictactoe" target="_blank" rel="noreferrer">Github</a></button>
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://www.hyper-tictactoe.com/" target="_blank" rel="noreferrer">Link</a></button></div><hr /><br /></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[펫칭] 펫시터와 반려동물 주인 매칭 웹 서비스&nbsp;
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://github.com/Petching/Petching" target="_blank" rel="noreferrer">Github</a></button>
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://petching.net/" target="_blank" rel="noreferrer">Link</a></button></div><hr /><br /></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[도와조약] 사용자 알러지 기반 알약 추천 웹 서비스&nbsp;
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://github.com/codestates-seb/seb43_main_009" target="_blank" rel="noreferrer">Github</a></button>
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://dowajoyak.store" target="_blank" rel="noreferrer">Link</a></button></div><hr /><br /></div>
            ...
            <div className="project">
              ...
              <div><div className="large-div">[해커톤: 같이탈래] 같은 경로를 이용하는 택시 이용자를 매칭하는 어플리케이션&nbsp;
                <button style={{ backgroundColor: "lightblue", fontWeight: "bold" }}><a style={{ color: "darkgray", textDecoration: "none" }} href="https://github.com/nowaveosu/gachiTarlae" target="_blank" rel="noreferrer">Github</a></button>
                </div><hr /><br /></div>
